...
#define _GUIESC LGUI_T(KC_ESC)
#define _SHWIN  C(KC_UP)

#define _WIND_G MO(_WINDOWS)
#define _SHOT_Q LT(_SHORTCUTS, KC_Q)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LCTL, KC_LALT, KC_TAB , KC_DEL , KC_BSPC, _GUIESC,    KC_ENT , KC_SPC , KC_MINS, _SHWIN , KC_BSLS, KC_QUOT
  ),
  [_SYMBOLS] = LAYOUT(
  ...
  [_SHORTCUTS] = LAYOUT(
    XXXXXXX, XXXXXXX, XXXXXXX, LSG(KC_E), LSG(KC_H),                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
