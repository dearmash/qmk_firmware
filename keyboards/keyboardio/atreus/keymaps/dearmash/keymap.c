...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LCTL, KC_LALT, KC_TAB , KC_ESC , KC_BSPC, KC_LGUI,    KC_ENT , KC_SPC , KC_DEL , XXXXXXX, KC_BSLS, KC_QUOT
  ),
  [_SYMBOLS] = LAYOUT(
    ...
    KC_LCTL, KC_LALT, KC_TAB , KC_ESC , KC_BSPC, KC_LGUI,    KC_ENT , KC_SPC , KC_DEL , XXXXXXX, XXXXXXX, XXXXXXX
  ),
  [_DIGITS] = LAYOUT(
    ...
    KC_LCTL, KC_LALT, KC_TAB , KC_ESC , KC_BSPC, KC_LGUI,    KC_ENT , KC_SPC , KC_0   , KC_DOT , XXXXXXX, XXXXXXX
  ),
  [_MOVEMENT] = LAYOUT(
  ...
  [_SHORTCUTS] = LAYOUT(
    QK_BOOT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                      XXXXXXX, HYPR(KC_F1), HYPR(KC_F2), HYPR(KC_F3), HYPR(KC_F4),
